...
var _ = Describe("Resolver", func() {
	init := func(ctx context.Context) (*Resolver, jsonrpc.Validator, *redis.Client) {
		...
		resolver := New(multichain.NetworkTestnet, logger, cacher, multiaddrStore, nil, database, jsonrpc.Options{}, compatStore, versionStore, gpubkeyStore, bindings, mockVerifier, "")
